...
public class FastCash extends JFrame implements ActionListener {
    ...
    FastCash(String pin) {
        ...
        l3.setBounds(0, 0, 1550, 780);
        add(l3);

        JLabel label = new JLabel("SELECT WITHDRAWL ACCOUNT");
